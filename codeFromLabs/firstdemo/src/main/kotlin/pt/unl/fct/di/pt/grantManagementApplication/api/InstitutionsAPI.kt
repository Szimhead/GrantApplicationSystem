...
interface InstitutionsAPI {
    ...
    @ApiOperation(value = "Add an Institution with given id")
    @ApiResponses(value = [
    ...
    @PostMapping("/{id}")
    fun addInstitution(@ApiParam(name = "id", type = "Long", value = "The id of the institution being added", required = true)
    ...
    @ApiOperation(value = "Add Student with studentNr to Institution with a given id")
    @ApiResponses(value = [
    ...
    @PostMapping("/{id}/students/{studentNr}")
    fun addStudent(@ApiParam(name = "id", type = "Long", value = "The id of the institution to add the student to", required = true)
                   @PathVariable id:Long, @ApiParam(name = "studentNr", type = "Long", value = "The studentNr of the student being added", required = true)
    ...
    @ApiOperation(value = "Add Reviewer with reviewerNr to Institution with a given id")
    @ApiResponses(value = [
    ...
    @PostMapping("/{id}/reviewers/{reviewerNr}")
    fun addReviewer(@ApiParam(name = "id", type = "Long", value = "The id of the institution to add the reviewer to", required = true)
                    @PathVariable id:Long, @ApiParam(name = "reviewerNr", type = "Long", value = "The reviewerNr of the reviewer being added", required = true)
