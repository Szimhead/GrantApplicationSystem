...
data class GrantCallDTO(val title:String, val description: String, val funding: Float, val openDate: Date, val closeDate: Date)
...
data class AnswerDTO(val value: String, val datatype: String)
